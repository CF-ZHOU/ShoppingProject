...
public class DataBase {
    ...
    public DataBase(){
        ...
        //初始化商品数据
        goodsData.add(new Goods(101, "小米电视4C       ", 1999, 1, 100, "5abca3f7N357415cf.jpg", "小米", 100));
        goodsData.add(new Goods(102, "美的波轮洗衣机   ", 899, 1, 200, "ef34f15d34e0ddee.jpg", "美的", 50));
        ...
        goodsData.add(new Goods(105, "I79700K          ", 3099, 2, 500, "5bbf43e7Ndd80aff7.jpg", "英特尔", 30));
        goodsData.add(new Goods(106, "海韵PLUS650W     ", 749, 2, 600, "5a1fb25cNee12052f.jpg", "海韵", 120));
        goodsData.add(new Goods(107, "iPhoneXR128GB    ", 5299, 3, 700, "a2c208410ae84d1f.jpg", "苹果", 80));
